...
@Component({
    selector: 'app-proWorkPlanList',
    templateUrl: './proWorkPlanList.component.html',
    styleUrls: ['./proWorkPlanList.component.css']
})
export class ProWorkPlanListComponent implements OnInit {
    loading: boolean;
    columns: string[];
    ...
    constructor(private proPerspectiveS: ProPerspectiveService, private proStrategicObjetiveS: ProStrategicObjetiveService, 
        private proWorkPlanS: ProWorkPlanService, private alertS: AlertService) {
        this.loading = false;
