...
@Component({
  selector: 'app-loadClientListAllNew',
  templateUrl: './loadClientListAllNew.component.html',
  styleUrls: ['./loadClientListAllNew.component.css']
})

export class loadClientListAllNewComponent implements OnInit {
  uploading: boolean;
  loading: boolean;
  columns: string[];
  header: string[];
