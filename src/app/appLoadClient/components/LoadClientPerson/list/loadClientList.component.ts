...
import { LoadPersonCustomerModal } from "../../modal/LoadPersoCustomer/loadPersonCustomer.modal";
...
export class loadClientListComponent implements OnInit {
    loading: boolean;
    columns: string[];
    ...
    getCustomer(id:number){
        this.dialog.open(LoadPersonCustomerModal, {
            data: { 'personId': id },
            width: '600px'
        });
    }
