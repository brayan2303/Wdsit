...
@Component({
    selector: 'app-actListAproved',
    templateUrl: './actListAproved.component.html',
    styleUrls: ['./actListAproved.component.css']
})

export class ActListAprovedComponent implements OnInit {
    ...
    listAnswer() {
        this.activeFixedAprovS.listAproved().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
