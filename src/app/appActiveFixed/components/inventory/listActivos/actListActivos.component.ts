...
@Component({
    selector: 'app-actListActivos',
    templateUrl: './actListActivos.component.html',
    styleUrls: ['./actListActivos.component.css']
})

export class ActListActivosComponent implements OnInit {
    ...
    listAnswer() {
        this.activeFixedAprovS.listWoden().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
