...
@Component({
    selector: 'app-actListRenta',
    templateUrl: './actListRenta.component.html',
    styleUrls: ['./actListRenta.component.css']
})

export class ActListRentaComponent implements OnInit {
