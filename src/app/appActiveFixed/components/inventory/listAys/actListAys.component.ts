...
@Component({
    selector: 'app-actListAys',
    templateUrl: './actListAys.component.html',
    styleUrls: ['./actListAys.component.css']
})

export class ActListAysComponent implements OnInit {
    ...
    listAnswer() {
        this.activeFixedAprovS.listAys().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
