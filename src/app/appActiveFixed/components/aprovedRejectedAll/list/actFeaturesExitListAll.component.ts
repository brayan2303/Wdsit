...
@Component({
    selector: 'app-actFeaturesExitListAll',
    templateUrl: './actFeaturesExitListAll.component.html',
    styleUrls: ['./actFeaturesExitListAll.component.css']
})

export class ActAssigExitListAllComponent implements OnInit {
    ...
    listAnswer() {
        this.activeFixedAsigmentS.listAnswerAll().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
