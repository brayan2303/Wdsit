...
export class VariableModalForm {
    loading: boolean;
    columns: string[];
    ...
    constructor(private priVariableS:PriVariableService, private alertS: AlertService,
        public dialogRef: MatDialogRef<VariableModalForm>,
    ...
    ngOnInit(): void {
        this.loading = true;
        this.priVariableS.list().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
