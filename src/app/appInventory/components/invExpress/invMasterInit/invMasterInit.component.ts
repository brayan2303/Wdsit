...
@Component({
    selector: 'app-invMasterInit',
    templateUrl: './invMasterInit.component.html',
    styleUrls: ['./invMasterInit.component.css']
})

export class InvMasterInitComponent implements OnInit {
    loading: boolean;
    columns: string[];
    @Input() formId: number;
    ...
    serial(id: number, codigoSap: string) {
        this.dialog.open(InvSerialExpressComponent, {
            width: '100%',
