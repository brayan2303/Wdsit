...
@Component({
  selector: 'modal-invPartNumberResult',
  templateUrl: './invPartNumberResult.component.html',
  styleUrls: ['./invPartNumberResult.component.css']
})

export class InvPartNumberResultComponent implements OnInit {
  uploading: boolean;
  loading: boolean;
  columns: string[];
  header: string[];
  ...
  constructor(private invGeneralInitS: InvGeneralInitService, private alertS: AlertService, private dialog: MatDialog, private InvPartNumberDeftGeneralS: InvPartNumberDeftGeneralService, private fb: FormBuilder, public dialogRef: MatDialogRef<InvPartNumberResultComponent>,
