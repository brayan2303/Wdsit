...
import { TasTaskEditComponent } from '../../task/edit/tasTaskEdit.component';

@Component({
    selector: 'app-tasTaskListAll',
    templateUrl: './tasTaskListAll.component.html',
    styleUrls: ['./tasTaskListAll.component.css']
})
export class TasTaskListAllComponent implements OnInit {
    loading: boolean;
    columns: string[];
    ...
    ngOnInit(): void {
        ...
        this.loading = true;
        this.tasTaskS.listAll().subscribe(res => {
            if (res.message === 'OK') {
                this.loading = false;
