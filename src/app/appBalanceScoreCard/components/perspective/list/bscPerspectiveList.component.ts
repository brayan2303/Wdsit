...
@Component({
    selector: 'app-bscPerspectiveList',
    templateUrl: './bscPerspectiveList.component.html',
    styleUrls: ['./bscPerspectiveList.component.css']
})
export class BscPerspectiveListComponent implements OnInit {
    year:number;
    loading: boolean;
    columns: string[];
    ...
    constructor(private bscPerspectivePersonS: BscPerspectivePersonService, private chartS: ChartService, private alertS: AlertService) {
        this.year=0;
        this.loading = false;
